...
#End Region
        ...
        Private btnCreate As DevExpress.XtraEditors.SimpleButton

        Private btnModify As DevExpress.XtraEditors.SimpleButton

        Private toggleSwitchTimer As DevExpress.XtraEditors.ToggleSwitch
    End Class
End Namespace
