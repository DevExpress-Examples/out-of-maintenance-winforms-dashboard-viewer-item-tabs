...
Namespace TabSupportExample
    ...
    Public Module DataGenerator
        ...
        Public Function GenerateTestData() As List(Of TabSupportExample.DataRow)
            Dim data As System.Collections.Generic.List(Of TabSupportExample.DataRow) = New System.Collections.Generic.List(Of TabSupportExample.DataRow)()
            ...
            For Each country As String In countries
                For i As Integer = 0 To 100 - 1
                    data.Add(New TabSupportExample.DataRow With {.Country = country, .Sales = rand.NextDouble() * 100 * i, .SalesTarget = rand.NextDouble() * 100 * i, .SalesDate = System.DateTime.Now.AddDays(((If(i Mod 2 = 0, -1, 1)) * i) + rand.[Next](10, 40))})
                Next
            Next
        ...
        Public Sub SaveTestData()
            Dim data As System.Collections.Generic.List(Of TabSupportExample.DataRow) = TabSupportExample.DataGenerator.GenerateTestData()
